  ...
  <div class="bg-card rounded-lg">
    <div class="border-0 rounded-md">
      ...
      <div class="flex justify-between pb-4">
        <h3>HTML Code</h3>
        <button class="text-sm flex items-center text-muted-foreground hover:text-foreground transition-colors">
      ...
      <div class="w-full bg-neutral text-sm mr-2 rounded-lg overflow-x-auto text-white focus:outline-none">
        <pre
          class="focus:outline-none max-h-[300px] p-2 pl-3 ml-2"
        ><code class="language-html">{{ htmlCode }}</code></pre>
      </div>
    </div>
